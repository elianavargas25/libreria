...
public class SqlLibros {
    ...
    public static String getLibrosByCategoria() {
        return "SELECT LIB.ID_LIBROS, LIB.NOMBRE_LIBRO, LIB.EDITORIAL, LIB.NRO_PAGINAS,LIB.ANIO_PUBLICACION, LIB.UBICACION, LIB.VALOR, CAT.ID_CATEGORIA,\n"
                + "  CAT.DESCRIPCION,EDI.ID_EDITORIAL, EDI.NOMBRE_EDITORIAL,UBI.ID_UBICACION, UBI.NOMBRE_UBICACION,AU.ID_AUTOR,AU.NOMBRE_COMPLETO\n"
                + "FROM LIBROS LIB\n"
